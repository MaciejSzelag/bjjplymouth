...
<?php
    ...
    $days = [
        'Monday'    => [
            ['6am', '7am', 'Gi BJJ', 'Ian Harrop'],
            ['10am', '11am', 'Gi BJJ', 'Ian Harrop'],
            ['11am', '12pm', 'Gi BJJ Pro Training - Adults', 'Ian Harrop'],
            ['5:30pm', '6:15pm', 'Judo with Gi BJJ (kids)', 'Paul Roach'],
            ['6:30pm', '7:15pm', 'Gi BJJ Fundamentals', 'Elias Freeman / Paul Roach'],
            ['7:15pm', '8pm', 'Positional Sparring', 'Elias Freeman / Paul Roach'],

        ],
        'Tuesday'   => [
            ['10am', '11am', 'NoGi Class', 'Ian Harrop'],
            ['11am', '12pm', 'NoGi Pro Training (Adults)', 'Ian Harrop'],
            ['12pm', '1pm', 'Wresling (Adults)', 'Darrel Allen'],
            ['5pm', '6pm', 'KIDS & YOUTH CLASS', 'AT MARJON UNIVERSITY - start:03/02/2026'],
            ['6:30pm', '7:30pm', 'NoGi BJJ (Adults, Juniors & Kids over 8 y/o)', 'Ian Harrop'],
            ['7:30pm', '8:30pm', 'NoGi Positional Sparrings (Adults)', 'Ian Harrop'],
        ],
        'Wednesday' => [
            ['6am', '7am', 'Gi BJJ (Adults)', 'Ian Harrop'],
            ['10am', '11:00am', 'Open Mat', 'Ian Harrop'],
            ['7pm', '8pm', 'Gi BJJ', 'Ian Harrop'],
            ['8pm', '8:30pm', 'Gi BJJ - Pro Training', 'Ian Harrop'],
        ],
        'Thursday'  => [
            ['10am', '11am', 'NoGi', 'Ian Harrop'],
            ['11am', '12am', 'NoGi Pro Training', 'Ian Harrop'],
            ['6:30pm', '8pm', 'Comp GI', 'Ian Harrop'],
            ['7:30pm', '8pm', 'NoGi Pro Training', 'Ian Harrop'],
        ],
        'Friday'    => [
            ['6am', '7am', 'NoGi', 'Ian Harrop'],
        ...
        'Saturday'  => [
            ...
            ['1:30pm', '2:30pm', 'NoGi Wresling - Kids ONLY', 'Darrel Allen'],
        ],
        'Sunday'    => [
