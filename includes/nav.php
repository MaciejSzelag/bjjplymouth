...
?>" data-menu="Home">Home</a></li>
                    ...
                    <li><a class="<?php echo showActive('timetable', $active); ?>"
                            href="<?php echo homePageBaseUrl(""); ?>pages/timetable/"
                            data-menu="Timetable">Timetable</a></li>
                    <li><a class="<?php echo showActive('classes', $active); ?>"
                            href="<?php echo homePageBaseUrl(""); ?>pages/bjjclasses/" data-menu="Classes">Classes</a>
                    </li>
